...
const Application = () => {
  const text = 'Features Of Our Mobile Application'
  ...
  return (
    ...
    >
      ...
      <h2 className='mt-12 text-center text-[55px] leading-none lg:text-8xl font-semibold'>
        {letters.map((char, i) => {
      ...
      >
        <div className='feature-points-up w-full flex flex-wrap'>
          <div className='feature-point md:px-8 lg:px-8 py-8 relative md:w-1/2 lg:w-1/2'>
            ...
            <p className='text-xl lg:text-2xl text-[#909090]'>
              Sync medication schedules with the hardware.
            </p>
          ...
          <div className='feature-point md:px-8 lg:px-8 py-8 relative md:w-1/2 lg:w-1/2'>
            ...
            <p className='text-xl lg:text-2xl text-[#909090]'>
              Keep an eye on remaining medications.
            </p>
        ...
        <div className='feature-points-middle flex flex-wrap'>
          <div className='feature-point md:px-8 lg:px-8 py-8 relative md:w-1/2 lg:w-1/2'>
            ...
            <p className='text-xl lg:text-2xl text-[#909090]'>
              Digital storage for easy access to medicine details.
            </p>
            <div className='border-right hidden lg:block md:block absolute right-0 top-0 h-full w-[3px] bg-gradient-to-t from-[#90909000] to-black'></div>
          </div>
